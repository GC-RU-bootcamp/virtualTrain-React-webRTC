...
// this.state = { videoViews = [ {videoElement:somevalue, //such as `= document.createElement('video')`
...
// I just dont know:
// 1) what type of componet `newRemoteVideo` and `newRemoteAudio` to create. Do i look for a react video compenent such as 
//    Do i look to use a react video compenent such as https://www.npmjs.com/package/video-react
// 2) how to get the return value of document.createElement('video') in JSX. Do I need to or do i only need to create the componet and set the event.stream 
